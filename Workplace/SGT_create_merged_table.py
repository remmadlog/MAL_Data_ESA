...
table_main = pd.read_excel('created_files/Season_1970_2024_main.xlsx')
# table_main.heads()
...
table_SGT = pd.read_excel('created_files/Season_1970_2024_SGT.xlsx')
# table_SGT.head()
...
table_merged.to_excel("created_files/S_1970_2024_merged.xlsx", index=False)
table_merged_unique.to_excel("created_files/S_1970_2024_merged_unique.xlsx", index=False)
