...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
# df = pd.read_csv("xlsx_tables/training_score/selection_arranged_comb.csv").fillna(0)
# df = pd.read_csv("xlsx_tables/training_score/selection_arranged_comb2.csv").fillna(0)
# df = pd.read_csv("xlsx_tables/training_score/selection_arranged_comb4.csv").fillna(0)
# df = pd.read_csv("xlsx_tables/training_score/selection_arranged_intersection.csv").fillna(0)
df = pd.read_csv("xlsx_tables/training_score/selection_arranged_union.csv").fillna(0)
# df = pd.read_csv("xlsx_tables/training_score/selection_arranged_union2.csv").fillna(0)
# df = pd.read_csv("xlsx_tables/training_score/selection_arranged_union4.csv").fillna(0)
# df = pd.read_csv("xlsx_tables/training_score/selection_pure_anova.csv").fillna(0)
# df = pd.read_csv("xlsx_tables/training_score/selection_pure_chi2.csv").fillna(0)
# df = pd.read_csv("xlsx_tables/training_score/selection_pure_corval.csv").fillna(0)
# df = pd.read_csv("xlsx_tables/training_score/selection_pure_rrelieff.csv").fillna(0)
# df = pd.read_csv("xlsx_tables/training_score/selection_pure_tree.csv").fillna(0)
# df = pd.read_csv("xlsx_tables/training_score/selection_pure_univar.csv").fillna(0)
# df = pd.read_csv("xlsx_tables/training_score/selection_pure_var.csv").fillna(0)
...
# # uncomment to use
# scaling needed
# gs_MLP_reg(param_dict,X_train_scaled,y_train,3,10,"xlsx_tables/training_score/")
...
# # uncomment to use
# scaling not needed
# gs_tree_reg(param_dict,X_train,y_train,3,10,"xlsx_tables/training_score/")
...
# uncomment to use
# # scaling not needed
# get_forest_reg(param_dict,X_train,y_train,3,10,"xlsx_tables/training_score/")
...
#
# # uncomment to use
# get_logreg_reg(param_dict,X_train_scaled,y_train,3,10,"xlsx_tables/training_score/")
...
# uncomment to use
# get_gradboost_reg(param_dict,X_train_scaled,y_train,3,5,"xlsx_tables/training_score/")
...
# # uncomment to use
# get_Elasticnet_reg(param_dict,X_train_scaled,y_train,3,5,"xlsx_tables/training_score/")
...
# # uncomment to use
# get_SVR_reg(param_dict,X_train_scaled,y_train,3,5,"xlsx_tables/training_score/")
...
# get_XGB_reg(param_dict,X_train_scaled,y_train,3,3,"xlsx_tables/training_score/")
