...
> Use [selection_arranged_union.csv](xlsx_tables/training_score/selection_arranged_union.csv):  
> > **Very weak** silhouette score for KMeans: `n_cluster = 2, score = 0.17`


> Use [selection_arranged_intersection.csv](xlsx_tables/training_score/selection_arranged_intersection.csv):  
> > **Weak** silhouette score for KMeans: `n_cluster = 2, score = 0.31`


> Using the new created [training_full_set.csv](xlsx_tables/training_full_set.csv):  
...
> Using the new created [training_full_set.csv](xlsx_tables/training_full_set.csv) but selecting only a few features **by hand**
> General bad results:  
> 
> ```python
