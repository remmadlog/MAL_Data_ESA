...
- Used [selection_arranged_intersection.csv](xlsx_tables/training_score/selection_arranged_intersection.csv) in order to not have to many features early on.
...
- Forgot to fix the **random_state**.
  ...
  - Used the opportunity to change the dataset to [selection_arranged_union2.csv](xlsx_tables/training_score/selection_arranged_union2.csv) in hope of better results.
- Used [selection_arranged_union2.csv](xlsx_tables/training_score/selection_arranged_union2.csv).
  - Still hoping that the same parameter are giving good results for the larger feature set.
    - I do not think that this can work. 
      - The DecisionTreeRegressor gets very different parameters using [selection_arranged_union.csv](xlsx_tables/training_score/selection_arranged_union.csv).
      - Thought that it might give an indication, this seems not to be the case.
- Using [selection_arranged_union.csv](xlsx_tables/training_score/selection_arranged_union.csv).
...
Using 
- [selection_arranged_union.csv](xlsx_tables/training_score/selection_arranged_union.csv) and [selection_arranged_union2.csv](xlsx_tables/training_score/selection_arranged_union2.csv)
- r2 for scoring
...
Using 
- [selection_arranged_union.csv](xlsx_tables/training_score/selection_arranged_union.csv)
- MAE for scoring
