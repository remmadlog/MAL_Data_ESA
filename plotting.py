...
plt.savefig('Plots/Amount per year (Shows - TV+ - Movie+ - Rest).png', dpi=350, transparent=True)
...
plt.savefig('Plots/Amount per year (TV - OVA - ONA).png', dpi=350, transparent=True)
...
plt.savefig('Plots/Amount per year (Movie - Special).png', dpi=350, transparent=True)
plt.show()
...
# plt.legend(loc="upper left")
#
# plt.title("Score average -- Overview")
# plt.xlabel("Years")
...
#
# plt.legend(loc="upper left")
# plt.title("Score overview -- Total")
# plt.xlabel("Years")
# plt.ylabel("Score")
# plt.grid(linestyle = '--', linewidth = 0.5)
# plt.ylim(0,10)
...
#
# plt.legend(loc="upper left")
# plt.title("Score overview -- TV+ and Movie+")
# plt.xlabel("Years")
# plt.ylabel("Score")
# plt.grid(linestyle = '--', linewidth = 0.5)
# plt.ylim(0,10)
...
#
# plt.legend(loc="upper left")
# plt.title("Score overview -- Movie+")
# plt.xlabel("Years")
# plt.ylabel("Score")
# plt.grid(linestyle = '--', linewidth = 0.5)
# plt.ylim(0,10)
...
#
# plt.legend(loc="upper left")
# plt.title("Score overview -- Music+")
# plt.xlabel("Years")
# plt.ylabel("Score")
# plt.grid(linestyle = '--', linewidth = 0.5)
# plt.ylim(0,10)
...
#
# plt.legend(loc="upper left")
# plt.title("Score overview -- Special")
# plt.xlabel("Years")
# plt.ylabel("Score")
# plt.grid(linestyle = '--', linewidth = 0.5)
# plt.ylim(0,10)
